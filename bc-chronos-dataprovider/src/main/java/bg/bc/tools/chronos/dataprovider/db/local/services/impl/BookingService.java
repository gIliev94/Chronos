...
import bg.bc.tools.chronos.dataprovider.db.repos.BookingRepository;
...
public class BookingService implements IBookingService {
	...
	HolidayManager m = HolidayManager.getInstance(ManagerParameters.create(HolidayCalendar.BULGARIA));
	final Set<Holiday> holidays = m.getHolidays(LocalDate.of(2017, 03, 03), LocalDate.of(2017, 05, 02));
