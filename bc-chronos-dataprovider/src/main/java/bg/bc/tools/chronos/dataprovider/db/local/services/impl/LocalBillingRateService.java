...
import bg.bc.tools.chronos.dataprovider.db.local.repos.LocalBillingRateRepository;
import bg.bc.tools.chronos.dataprovider.db.local.services.ifc.ILocalBillingRateService;

public class LocalBillingRateService implements ILocalBillingRateService {

    @Autowired
    private LocalBillingRateRepository billingRateRepo;
