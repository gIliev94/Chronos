...
import bg.bc.tools.chronos.dataprovider.db.repos.BillingRateRepository;

public class BillingRateService implements IBillingRateService {

    @Autowired
    private BillingRateRepository billingRateRepo;
